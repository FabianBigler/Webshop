...
{		
	...
	{
		//this->initConnection();		
		//SELECT `productIngredient`.`id`, `productIngredient`.`product-id`, 
		//`productIngredient`.`position`, ingredient.name FROM `productIngredient` 
		//LEFT JOIN ingredient ON (ingredient.id=`productIngredient`.`ingredient-id` 
		//AND ingredient.`language-code`='DE')
	}	
}
?>
